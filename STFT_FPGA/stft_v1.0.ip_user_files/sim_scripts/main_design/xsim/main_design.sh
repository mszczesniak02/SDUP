...
export RDI_DATADIR="/home/krzeslaav/Programs/vivado25/2025.2/data"
...
simulate()
{
  xsim main_design -key {Behavioral:sim_1:Functional:main_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_ad5e.protoinst" -protoinst "protoinst_files/bd_f991.protoinst" -protoinst "protoinst_files/main_design.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/krzeslaav/Programs/vivado25/2025.2/data/xsim"
  fi
