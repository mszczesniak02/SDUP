...
HD_PWD='/home/krzeslaav/SEM_1/sdup_project/STFT_FPGA/stft_v1.0.runs/main_design_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_design_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_design_axi_smc_0.tcl
