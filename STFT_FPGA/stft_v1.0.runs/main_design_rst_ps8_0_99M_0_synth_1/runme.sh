...
HD_PWD='/home/krzeslaav/SEM_1/sdup_project/STFT_FPGA/stft_v1.0.runs/main_design_rst_ps8_0_99M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_design_rst_ps8_0_99M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_design_rst_ps8_0_99M_0.tcl
