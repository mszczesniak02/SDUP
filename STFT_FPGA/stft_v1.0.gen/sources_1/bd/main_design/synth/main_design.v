...
(* CORE_GENERATION_INFO = "main_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=main_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=5,da_board_cnt=1,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "main_design.hwdef" *) 
module main_design
   ();
  ...
  wire [31:0]stft_axis_wrapper_0_M_AXIS_TDATA;
  wire stft_axis_wrapper_0_M_AXIS_TLAST;
  wire stft_axis_wrapper_0_M_AXIS_TREADY;
  wire stft_axis_wrapper_0_M_AXIS_TVALID;
  ...
  main_design_axi_dma_0_0 axi_dma_0
       (.axi_resetn(rst_ps8_0_99M_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(stft_axis_wrapper_0_M_AXIS_TDATA),
        .s_axis_s2mm_tkeep({1'b1,1'b1,1'b1,1'b1}),
        .s_axis_s2mm_tlast(stft_axis_wrapper_0_M_AXIS_TLAST),
        .s_axis_s2mm_tready(stft_axis_wrapper_0_M_AXIS_TREADY),
        .s_axis_s2mm_tvalid(stft_axis_wrapper_0_M_AXIS_TVALID));
  ...
  main_design_axi_smc_1_0 axi_smc_1
       (.M00_AXI_araddr(axi_smc_1_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(rst_ps8_0_99M_peripheral_aresetn));
  main_design_rst_ps8_0_99M_0 rst_ps8_0_99M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  main_design_stft_axis_wrapper_0_0 stft_axis_wrapper_0
       (.ACLK(zynq_ultra_ps_e_0_pl_clk0),
        .ARESETN(rst_ps8_0_99M_peripheral_aresetn),
        .M_AXIS_TDATA(stft_axis_wrapper_0_M_AXIS_TDATA),
        .M_AXIS_TLAST(stft_axis_wrapper_0_M_AXIS_TLAST),
        .M_AXIS_TREADY(stft_axis_wrapper_0_M_AXIS_TREADY),
        .M_AXIS_TVALID(stft_axis_wrapper_0_M_AXIS_TVALID),
        .S_AXIS_TDATA(axi_dma_0_M_AXIS_MM2S_TDATA),
        .S_AXIS_TLAST(axi_dma_0_M_AXIS_MM2S_TLAST),
        .S_AXIS_TREADY(axi_dma_0_M_AXIS_MM2S_TREADY),
        .S_AXIS_TVALID(axi_dma_0_M_AXIS_MM2S_TVALID),
        .window_type(axi_gpio_0_gpio_io_o));
  main_design_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
