...
-- Date        : Sun Jun 14 20:47:39 2026
-- Host        : krzeslaav running 64-bit Ubuntu 24.04.4 LTS
-- Command     : write_vhdl -force -mode synth_stub -rename_top main_design_axi_smc_1_0 -prefix
--               main_design_axi_smc_1_0_ main_design_axi_smc_1_0_stub.vhdl
-- Design      : main_design_axi_smc_1_0
...
entity main_design_axi_smc_1_0 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of main_design_axi_smc_1_0 : entity is "main_design_axi_smc_1_0,bd_f991,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of main_design_axi_smc_1_0 : entity is "main_design_axi_smc_1_0,bd_f991,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of main_design_axi_smc_1_0 : entity is "yes";
end main_design_axi_smc_1_0;

architecture stub of main_design_axi_smc_1_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN main_design_zynq_ultra_ps_e_0_0_pl_clk0, ASSOCIATED_BUSIF M00_AXI:S00_AXI:S01_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN m_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_f991,Vivado 2025.2";
begin
end;
